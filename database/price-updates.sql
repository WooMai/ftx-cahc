...
UPDATE "public"."digital_asset_prices" SET "snapshot_latest"='$138.2471144' WHERE "id"='5180eae9-6934-40c3-a7c2-5ccf85bb9551' RETURNING "id", "name", "petition_price", "type", "snapshot_latest";
UPDATE "public"."digital_asset_prices" SET "snapshot_latest"='$3,888.8400000' WHERE "id"='725569ea-b1df-4d21-abbd-e15d0bb2ba99' RETURNING "id", "name", "petition_price", "type", "snapshot_latest";
